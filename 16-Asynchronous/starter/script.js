...
btn.addEventListener('click', () => {
  getCountryNeighbour('Saudi');
  getCountryNeighbour('britain');
});
*/
...
const whereAmI = async function () {
  try {
    ...
    //Reject Promise returned from the function
    throw err;
  }
};
...
const get3Countries = async function (c1, c2, c3) {
  try {
    ...
    data.forEach(d => renderCountry(d[0]));
  } catch (err) {
    console.error(err.message);
  }
};

get3Countries('pakistan', 'saudi', 'bangladesh');
*/
